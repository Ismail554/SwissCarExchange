                  ...
                  background: Stack(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Icon(Icons.directions_car, color: Colors.white54, size: 80.sp),
                      ),
                      ...
                      Positioned(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              "BMW M5 2023",
                              style: FontManager.displaySmall(color: Colors.white).copyWith(fontSize: 24.sp),
                            ),
                            SizedBox(height: 4.h),
                            Text(
                              "Lot €4557 • 12 Gebote",
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: FontManager.labelSmall(color: AppColors.sceTeal).copyWith(letterSpacing: 1.2),
                            ),
                            SizedBox(height: 4.h),
                            Row(
                      ...
                      GridView.count(
                        ...
                        children: [
                          _buildDataCard(Icons.calendar_today_outlined, "Baujahr", "2023"),
                          _buildDataCard(Icons.speed_outlined, "Kilometerstand", "45,000 km"),
                          _buildDataCard(Icons.local_gas_station_outlined, "Kraftstoff", "Benzin"),
                          _buildDataCard(Icons.location_on_outlined, "Standort", "Zürich, CH"),
                        ],
                      ),
                      ...
                      Container(
                        ...
                        child: Text(
                          ...
                          style: FontManager.bodyMedium(color: AppColors.textHint).copyWith(height: 1.5),
                        ),
                      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            value,
            style: FontManager.bodyMedium(color: Colors.white).copyWith(fontWeight: FontWeight.bold),
            maxLines: 1,
